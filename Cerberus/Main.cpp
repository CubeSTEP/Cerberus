...
#include <Cerberus/Top/CerberusTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    Cerberus::setupTopology(inputs);
    Cerberus::startSimulatedCycle(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    Cerberus::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
