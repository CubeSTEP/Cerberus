// ======================================================================
// \title  CerberusTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <Cerberus/Top/CerberusTopologyAc.hpp>
// Note: Uncomment when using Svc:TlmPacketizer
//#include <Cerberus/Top/CerberusPacketsAc.hpp>

// Necessary project-specified types
#include <Fw/Types/MallocAllocator.hpp>
#include <Svc/FrameAccumulator/FrameDetector/FprimeFrameDetector.hpp>
#include <Cerberus/Top/Ports_ComPacketQueueEnumAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::Cerberus_tlmSend::WARN, PingEntries::Cerberus_tlmSend::FATAL, "chanTlm"},
    {PingEntries::Cerberus_cmdDisp::WARN, PingEntries::Cerberus_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::Cerberus_cmdSeq::WARN, PingEntries::Cerberus_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::Cerberus_eventLogger::WARN, PingEntries::Cerberus_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Cerberus_fileDownlink::WARN, PingEntries::Cerberus_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Cerberus_fileManager::WARN, PingEntries::Cerberus_fileManager::FATAL, "fileManager"},
    {PingEntries::Cerberus_fileUplink::WARN, PingEntries::Cerberus_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Cerberus_prmDb::WARN, PingEntries::Cerberus_prmDb::FATAL, "prmDb"},
    {PingEntries::Cerberus_rateGroup1::WARN, PingEntries::Cerberus_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Cerberus_rateGroup2::WARN, PingEntries::Cerberus_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Cerberus_rateGroup3::WARN, PingEntries::Cerberus_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology(const TopologyState& state) {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(CerberusPacketsPkts, CerberusPacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Cerberus
namespace Cerberus {
