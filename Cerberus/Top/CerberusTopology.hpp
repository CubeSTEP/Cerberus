// ======================================================================
// \title  CerberusTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CERBERUS_CERBERUSTOPOLOGY_HPP
#define CERBERUS_CERBERUSTOPOLOGY_HPP
// Included for access to Cerberus::TopologyState and Cerberus::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Cerberus/Top/CerberusTopologyDefs.hpp>

// Remove unnecessary Cerberus:: qualifications
 ...
 * Cerberus::TopologyState see: CerberusTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Cerberus::TopologyState see: CerberusTopologyDefs.hpp.
 *
